 ...
 *
 * @note   Verify that this driver is suitable for your device and do any necessary
 *         adjustments. Use the atomic_load_explicit and atomic_compare_exchange_weak_explicit()
