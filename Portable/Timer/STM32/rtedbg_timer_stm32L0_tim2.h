...
// Other values of number format ID bits are not possible for current implementation of this file
#error "RTE_FMT_ID_BITS must be 15 for a 16-bit timer TIM2 and current implementation of this driver."
#endif
